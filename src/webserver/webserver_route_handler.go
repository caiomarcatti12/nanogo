...
import (
	...
	"github.com/caiomarcatti12/nanogo/v3/src/mapper"
	"github.com/caiomarcatti12/nanogo/v3/src/validator"
...
func (ws *WebServer) debugInput(w http.ResponseWriter, r *http.Request, payload map[string]interface{}) {
	...
	instanceInterface, err := di.GetContainer().GetByFunctionConstructor(log.Factory)
